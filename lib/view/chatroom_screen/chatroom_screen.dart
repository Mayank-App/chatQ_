...
import 'package:chat_application/view/chatroom_screen/widget/chat_info_dialog.dart';
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          leading:Consumer<ChatRoomScreenProvider>(builder: (context,value, child) {
            ...
            icon:const Icon(Icons.arrow_back_ios_new_rounded,color: AppColors.blueAccent,size: 30,)) :IconButton(onPressed: () {
          ...
          title: Consumer<ChatRoomScreenProvider>(builder: (context,value,child) {
            ...
            return Icon(Icons.circle, color: status == 1? AppColors.green:AppColors.white,);
            }),
              ],
            ):
            Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () {
                                                ...
                                                //     messages[index], 0);
                                               value.toggleMessage(chatList[index]);
                                              },
                                              onDoubleTap: () {},
                                              onLongPress: (){
                                                showDialog(context: context, builder: (context)=>Dialog(child: ChatInfoDialog(messageModel: chatList[index],),));
                                              },
                                              child: Card(
                                                      ...
                                                      children: [
                                                        Container(
                                                            ...
                                                            children:[
                                                              ...
                                                              isImage  ? Text(
                                                            chatList[index].message +" "+ chatList[index].visibleNo.toString(),
